...
plot(id_long_lat_state_r[,2],id_long_lat_state_r[,3],pch=id_long_lat_state_r[,4],cex=0.5,xlab="",ylab="", axes = FALSE, main = "Continental US - All Constraints")
print_constraints(apply(id_long_lat_state_r[,1:3],2,as.numeric),constraints,type=c("ADJ","CO"))
