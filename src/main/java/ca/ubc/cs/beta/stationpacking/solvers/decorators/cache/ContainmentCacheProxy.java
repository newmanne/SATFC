...
public class ContainmentCacheProxy {
    ...
    public static class ContainmentCacheRequest {
        ...
        private ICacher.CacheCoordinate coordinate;
    }

    public ContainmentCacheSATResult proveSATBySuperset(StationPackingInstance instance, ICacher.CacheCoordinate coordinate) {
