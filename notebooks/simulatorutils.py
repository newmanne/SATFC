...
class MultiBandAuctionState(object):
    ...
    def _ending_state(self):
        ...
        return self.df.query('stage == %d and round == %d' % (max_stage, max_round_for_max_stage))
    ...
    def total_cost(self):
        return self._ending_state()['price'].sum()
    ...
    def total_value_loss(self):
        ...
        value_loss = (home_band_values - final_band_values).sum()
        return value_loss
    ...
    def n_rounds(self):
        return self.df.reset_index()[['stage', 'round']].drop_duplicates().count().iloc[0]
