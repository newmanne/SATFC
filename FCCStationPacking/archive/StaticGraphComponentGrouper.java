...
public class StaticGraphComponentGrouper implements IComponentGrouper{
	 ...
	 * @throws Exception
	 */
	public StaticGraphComponentGrouper(Set<Station> aStations, Set<Constraint> aConstraints) throws Exception
	{
