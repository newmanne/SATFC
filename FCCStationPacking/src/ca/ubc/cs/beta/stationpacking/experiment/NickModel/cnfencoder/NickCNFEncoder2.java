...
public class NickCNFEncoder implements ICNFEncoder {
	...
	private Map<Station,Integer> fInternalID;
	private int fmin_Channel,fmax_Channel,fnum_Clauses = 0;
							...
							Map<Station,Set<Station>> aADJplusConstraints)
	{
		...
		String tempFileName = "/Users/narnosti/Documents/fcc-station-packing/Output/CNF_file_temp.txt";
		...
		try{
			...
			System.out.println("IO error in NickCNFEncoder\n"+e);
		}
	}
