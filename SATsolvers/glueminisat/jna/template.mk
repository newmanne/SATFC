...
slibs:	lib$(LIB)_standard.so
slibp:	lib$(LIB)_profile.so
slibd:	lib$(LIB)_debug.so
slibr:	lib$(LIB)_release.so

## Compile options
%.o:			CFLAGS +=$(COPTIMIZE) -g -D DEBUG -fPIC
%.op:			CFLAGS +=$(COPTIMIZE) -pg -g -D NDEBUG -fPIC
%.od:			CFLAGS +=-O0 -g -D DEBUG -fPIC
%.or:			CFLAGS +=$(COPTIMIZE) -g -D NDEBUG -fPIC
...
## Shared Library Soft Link rule:
#slibs slibp slibd slibr:
