...
> bash compile.sh
\end{lstlisting}
Note that this version of \clasp requires some threading library that may not be part of your linux distribution - keep an eye on the output of the compile script.
