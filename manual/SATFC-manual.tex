...
> ./gradlew installApp
\end{lstlisting}
This build and package \SATFC in \texttt{<SATFC repository>/build/install/}. This may be a lengthy process as it is possibly installing Gradle, downloading all of \SATFC's dependencies and building the project. Note that it can sometimes fail while trying to download dependencies - restarting the process fixes this.
