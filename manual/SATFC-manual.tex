...
Packaged with \SATFC are its source code, necessary libraries as well as a copy of \clasp. The latter needs to be compiled on your machine:
...
Only the source code is provided with \SATFC. To build your own command-line executable version, execute the following:
\begin{lstlisting}[style=Bash]
> cd <SATFC repository>
> gradlew installApp
\end{lstlisting}

This will build and package \SATFC in \texttt{<SATFC repository>/build/install/}.
